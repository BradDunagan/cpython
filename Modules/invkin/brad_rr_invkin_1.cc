...
#define	J7Set	bJSet[6]
    ...
    //
    const double d1 =     5.000000;
    const double a3 =     8.000000;
    const double d5 =     8.000000;
    ...
    for ( itr = 0; (itr < 2) && ! bError; itr++ )
    {
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            double  d = d5;
            double  a = a3;
            double  SJ = (((((k1 * k1) + (k2 * k2)) + ((-1 * d) * d)) + ((-1 * a) * a)) * (1 / ((2 * d) * a)));
            double  qa = (1 + ((-1 * SJ) * SJ));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            //  Intermediate terms.
            //
            double  y = ((-S2 * ((C1 * nx) + (S1 * ny))) + (C2 * nz));
            double  x = ((-S2 * ((C1 * ox) + (S1 * oy))) + (C2 * oz));
            ...
            double  Ja = ((-1 * J7) + atan2(y, x));
            double  Jb = (J7 + atan2(y, x));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            double  Ja = (J7 + atan2(y, x));
            double  Jb = ((-1 * J7) + atan2(y, x));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            double  Ja = ((-1 * J5) + atan2(y, x));
            double  Jb = (J5 + atan2(y, x));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            double  Ja = (J5 + (-1 * atan2(y, x)));
            double  Jb = ((-1 * J5) + (-1 * atan2(y, x)));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            double  x = (((C2 * C34) * S5) + (-S2 * -C5));
            double  y = (((((C2 * C34) * C5) + (-S2 * S5)) * C6) + ((C2 * S34) * S6));
            double  qa1 = ((x * x) + (y * y));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            double  x = (((((C2 * C34) * C5) + (-S2 * S5)) * C6) + ((C2 * S34) * S6));
            double  y = (((C2 * C34) * S5) + (-S2 * -C5));
            double  qa1 = ((x * x) + (y * y));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            //
            double  k = nz;
            double  x = (((S2 * C34) * S5) + (C2 * -C5));
            double  y = (((((S2 * C34) * C5) + (C2 * S5)) * C6) + ((S2 * S34) * S6));
            double  qa1 = ((x * x) + (y * y));
        ...
        while ( ! bJSet[iJ] )
        {
            ...
            //  Intermediate terms.
            //
            double  x = ((S4 * ((C3 * ((C2 * ((C1 * ax) + (S1 * ay))) + (S2 * az))) + (S3 * -((S1 * ax) + (-C1 * ay))))) + (-C4 * ((-S3 * ((C2 * ((C1 * ax) + (S1 * ay))) + (S2 * az))) + (C3 * -((S1 * ax) + (-C1 * ay))))));
            double  qa = (1 + (-1 * (x * x)));
